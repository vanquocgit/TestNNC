...
export function createParticles(clock, THREElib) {
    const sphereGeo = new THREElib.SphereGeometry(0.5, 32, 32);
    const boxGeo = new THREElib.BoxGeometry(0.55, 0.55, 0.55);
    ...
    const candyGeo = new THREElib.TubeGeometry(curve, 16, 0.08, 8, false);
